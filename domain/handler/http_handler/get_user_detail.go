...
// @Success 200 {object} http_response.Response{data=response.User,statusCode=int,message=string}
...
func (h *handler) GetUserDetail(c *gin.Context) {
	...
	result, err := h.usecase.GetUserDetail(c.Request.Context(), in.ToPayload())
	if err != nil {
